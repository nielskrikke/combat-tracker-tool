...
const parseMarkdown = (text: string) => {
    ...
    let html = text
      ...
      .replace(/^## (.*$)/gim, '<h2 class="text-2xl font-bold mt-5 mb-2 border-b border-white/10 pb-1">$1</h2>')
      .replace(/^# (.*$)/gim, '<h1 class="text-3xl font-bold mt-6 mb-3 border-b-2 border-white/10 pb-2">$1</h1>')
